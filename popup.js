...
(async function () {
    ...
    function updateUI() {
        ...
        if (siteRule) {
            ...
            if (siteRule.enabled === false) {
                siteRuleInfo.textContent =
                    "⚠️ Extension is disabled on this site";
                ...
                siteRuleInfo.textContent =
                    "📌 Font is always off for this site";
            }
        } else {
    ...
    function openHelp(e) {
        e.preventDefault();
        chrome.tabs.create({
            url: "https://github.com/gvajda/OpenDyslexicChromeExtension#readme",
        });
    }
